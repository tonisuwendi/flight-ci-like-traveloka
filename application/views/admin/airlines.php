...
<div class="card shadow">
  ...
  <div class="card-body">
    <form action="<?= base_url(); ?>admin/<?= isset($_GET['id']) ? 'edit_airline/' . $_GET['id'] : 'airlines/' ?>" method="post">
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="logo" name="logo" class="form-control" placeholder="https://maskapai.com/logo.png" value="<?= isset($_GET['logo']) ? $_GET['logo'] : null ?>" required autocomplete="off">
          </div>
        </div>
        <div class="col-12">
      ...
      <tbody>
        ...
        foreach ($airline->result_array() as $data) : ?>
          <tr>
            <td><?= $no ?></td>
            <td><?= $data['name'] ?></td>
            <td><img height="30px" src="<?= $data['logo'] ?>" alt="<?= $data['name'] ?>"></td>
            <td>
